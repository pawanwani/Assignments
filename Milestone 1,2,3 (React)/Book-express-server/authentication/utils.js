...
exports.AuthenticateUser = exports.findEmail = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    decode = jsonwebtoken_1.default.verify(token, "" + process.env.JWTstring);
                    return [4 /*yield*/, users_1.default.findById(decode.userId)];
                case 1:
                    User = _a.sent();
                    try {
                        if (!User) {
                ...
                case 3:
                    error_2 = _a.sent();
                    res.status(404).send(error_2.message);
                    return [3 /*break*/, 4];
