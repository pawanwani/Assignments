...
let addBooks =document.getElementById("add-book")
if(addBooks!=null){
   addBooks.onclick = function(){
      (<HTMLInputElement>document.getElementById("addbook-part")).style.display = "block";
      (<HTMLInputElement>document.getElementById("displaybook-part")).style.display = "none";
   }
}
...
if(showtable!=null){
   showtable.onclick=function(){
      (<HTMLInputElement>document.getElementById("displaybook-part")).style.display = "block";
      (<HTMLInputElement>document.getElementById("addbook-part")).style.display = "none";
